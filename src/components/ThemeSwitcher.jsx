        ...
        <AnimatePresence>
            <motion.aside
                animate={{
                    ...
                    padding: isThemeButtonHovered && !isMenuOpen ? '2rem 1rem' : '.5rem 1rem'
                }}
                transition={{
                    type: 'spring',
                    stiffness: 2500,
                ...
                <label htmlFor="theme" className="switch">
                    <input type="checkbox" id="theme" checked={isLightTheme} onChange={handleThemeChange} />
                    <span className="slider round icon">
                        { isLightTheme ? (
                ...
                <motion.button 
                    onHoverStart={() => setIsThemeButtonHovered(true)}
                    onHoverEnd={() => setIsThemeButtonHovered(false)}
                    type="button"
                    className="icon arrows icon-arrow-left"
